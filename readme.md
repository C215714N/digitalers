...
Esto es una guia para los alumnos de la capacitacion __digitalers nodejs__ que cursan los dias _miercoles y viernes de 19hs a 22hs_ donde podran acceder al material y descargar los contenidos trabajados en clase
...
1. Realizar el tipo de lista que corresponda y ordenar, en caso que sea necesario, los siguientes elementos:
   ...
   * "Taylor Fritz (4675 pts)", "Jannik Sinner (10380 pts)", "Novak Djokovic (4130 pts)", "Alexander Zverev (7285 pts)", "Carlos Alcaraz (8850 pts)", "Jack Draper (4440 pts)"
